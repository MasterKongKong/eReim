<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RolePage.aspx.cs" Inherits="eReimbursement.RolePage" %>
                        ...
                        <Center>
                            <ext:Panel ID="Panel3" runat="server" Title="" Height="00" MinHeight="300"
                                ...
                                <Items>
                                    ...
                                    <ext:Button ID="Button1" runat="server" Text="Save" Width="75" X="420" Y="20">
                                     <DirectEvents>
                                            <Click OnEvent="SAVE_Search">
                                            </Click>
                                        </DirectEvents>
                                    </ext:Button>
                                      <ext:Button ID="Button2" runat="server" Text="Unit Setting" Width="75" X="520" Y="20">
                                        <DirectEvents>
                                            <Click OnEvent="BACK">
                                            </Click>
                                        </DirectEvents>

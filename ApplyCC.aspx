<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyCC.aspx.cs" Inherits="eReimbursement.ApplyCC" %>
    ...
    <ext:Panel ID="Panel3" runat="server" Height="450" Width="850" Border="false" Padding="10"
        ...
        <Items>
            <ext:Panel ID="Panel4" runat="server" X="10" Y="10" Height="160" Layout="AbsoluteLayout"
                Padding="10">
                <Items>
                    <ext:Label ID="Label1" runat="server" Text="作用区间:" Width="55" X="10" Y="10" />
                    <ext:Label ID="Label2" runat="server" Text="1月-6月" Width="100" X="65" Y="10" />
                    ...
                    <ext:Label ID="Label9" runat="server" Text="类型:" Width="55" X="10" Y="40" />
                    <ext:Label ID="Label10" runat="server" Text="IP电话费" Width="100" X="65" Y="40" />
                    ...
                    <ext:Button ID="Button1" runat="server" Text="返回" X="10" Y="100" Width="75">
                        <Listeners>

...
public class Comm
{
  public static DBAdapter dbs;
    ...
    public static DataTable RtnEB(string userid, string dpt, string ostation, string tstation, string accountcode, string Years, string month)
    {
        ...
        string travelUsed = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  " + sss + "='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "'").ToString();
        string commUsed = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0))  from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0'  and a.status='2' and   " + sss + "='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "'").ToString();
       // string Budget = dbs.ExeSqlScalar("SELECT sum(b.Amount) FROM BudgetDetail as b inner join BudgetMain  as a on a.id=b.fid where b.station='" + thestation + "' AND b.BaccountCode='" + accountcode + "' AND b.MONTHS='" + month + "' and a.Years='" + Years + "'");
        ...
        if (ostation != tstation)
        {
            string qtravelUsed3 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + tstation + "' AND ACCOUNTCODE='" + accountcode + "' AND year(tdate)='" + Years + "'").ToString();
            string qcommUsed3 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0))  from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + tstation + "' AND ACCOUNTCODE='" + accountcode + "'  and year(tdate)='" + Years + "' ").ToString();
            string qBudget3 = dbs.ExeSqlScalar("SELECT isnull(m1,0)+isnull(m2,0)+isnull(m3,0)+isnull(m4,0)+isnull(m5,0)+isnull(m6,0)+isnull(m7,0)+isnull(m8,0)+isnull(m9,0)+isnull(m10,0)+isnull(m11,0)+isnull(m12,0) from  BudgetMain  where  station='" + thestation + "' AND BaacountCode='" + accountcode + "' and Years='" + Years + "' ");
            double qtt3 = jds(qtravelUsed3) + jds(qcommUsed3);
            DataRow qdr3 = dt.NewRow();
            qdr3["Type"] = "全年站点";
        ...
        else
        {
            ...
            //    depp = "Deptment";
            //}
            string travelUsed2 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where a.type='0'  and a.status='2' and station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "' and a.Department='" + dpt + "'").ToString();
            string commUsed2 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0)) from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "' and a.Department='" + dpt + "'").ToString();
            string Budget2 = dbs.ExeSqlScalar("SELECT sum(b.Amount) FROM BudgetDetail as b inner join BudgetMain  as a on a.id=b.fid where b.station='" + thestation + "' AND  b.BaccountCode='" + accountcode + "' AND b.MONTHS='" + month + "' and a.Years='" + Years + "' and " + depp + "='" + dpt + "'");
            double tt2 = jds(travelUsed2) + jds(commUsed2);
            DataRow dr2 = dt.NewRow();
            dr2["Type"] = "部门";
            ...
            //if (int.Parse(type) > 0)
            //{
            string travelUsed1 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "' and PersonID='" + userid + "'").ToString();
            string commUsed1 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0)) from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  AND MONTH(tdate)='" + month + "' and year(tdate)='" + Years + "' and PersonID='" + userid + "'").ToString();
            string Budget1 = dbs.ExeSqlScalar("SELECT sum(b.Amount) FROM BudgetDetail as b inner join BudgetMain  as a on a.id=b.fid where b.station='" + thestation + "' AND b.BaccountCode='" + accountcode + "' AND b.MONTHS='" + month + "' and a.Years='" + Years + "' and userid='" + userid + "'");
            double tt1 = jds(travelUsed1) + jds(commUsed1);
            DataRow dr1 = dt.NewRow();
            dr1["Type"] = "个人";
            ...
            string qtravelUsed1 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND year(tdate)='" + Years + "' and PersonID='" + userid + "'").ToString();
            string qcommUsed1 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0)) from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  and year(tdate)='" + Years + "' and PersonID='" + userid + "'").ToString();
            string qBudget1 = dbs.ExeSqlScalar("SELECT sum(b.Amount) FROM BudgetDetail as b inner join BudgetMain  as a on a.id=b.fid where b.station='" + thestation + "' AND b.BaccountCode='" + accountcode + "' and a.Years='" + Years + "' and userid='" + userid + "'");
            double qtt1 = jds(qtravelUsed1) + jds(qcommUsed1);
            DataRow qdr1 = dt.NewRow();
            qdr1["Type"] = "全年个人";
            ...
            string qtravelUsed2 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND year(tdate)='" + Years + "' and a.Department='" + dpt + "'").ToString();
            string qcommUsed2 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0)) from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  and year(tdate)='" + Years + "' and a.Department='" + dpt + "'").ToString();
            string qBudget2 = dbs.ExeSqlScalar("SELECT sum(b.Amount) FROM BudgetDetail as b inner join BudgetMain  as a on a.id=b.fid where b.station='" + thestation + "' AND b.BaccountCode='" + accountcode + "' and a.Years='" + Years + "' and Deptment='" + dpt + "'");
            double qtt2 = jds(qtravelUsed2) + jds(qcommUsed2);
            DataRow qdr2 = dt.NewRow();
            qdr2["Type"] = "全年部门";
            ...
            qdr2["Station"] = thestation;
            dt.Rows.Add(qdr2);
            string qtravelUsed3 = dbs.ExeSqlScalar("select sum(isnull(b.CenterAmountP,0))+sum(isnull(b.CenterAmountC,0)) from ETraveleDetail as b inner join ETravel as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "' AND year(tdate)='" + Years + "'").ToString();
            string qcommUsed3 = dbs.ExeSqlScalar("select sum(isnull(b.CostCenterAmount,0)) from EeommonDetail as b inner join Ecommon as a on a.id=b.no where  a.type='0' and a.status='2' and  station2='" + thestation + "' AND ACCOUNTCODE='" + accountcode + "'  and year(tdate)='" + Years + "' ").ToString();
            string qBudget3 = dbs.ExeSqlScalar("SELECT sum(isnull(m1,0)+isnull(m2,0)+isnull(m3,0)+isnull(m4,0)+isnull(m5,0)+isnull(m6,0)+isnull(m7,0)+isnull(m8,0)+isnull(m9,0)+isnull(m10,0)+isnull(m11,0)+isnull(m12,0)) from  BudgetMain  where  station='" + thestation + "' AND BaacountCode='" + accountcode + "' and Years='" + Years + "' ");
            double qtt3 = jds(qtravelUsed3) + jds(qcommUsed3);

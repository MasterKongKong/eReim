<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuySet.aspx.cs" Inherits="eReimbursement.CuySet" %>
                ...
                <Items>
                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                            ...
                            <ext:Panel ID="Panel2" runat="server" Width="175">
                                <Items>
                                    <ext:TreePanel ID="TreePanel1" runat="server" Header="false" Lines="false" UseArrows="true"
                                        ...
                                        <Listeners>
                                            <AfterRender Handler="TreePanel1.getNodeById('a6').select(true);" />
                                        </Listeners>
                                    </ext:TreePanel>
                                </Items>
                            </ext:Panel>
                        ...
                        <Center>
                            ...
                            <ext:Panel ID="Panel3" runat="server" Title="Currency Setting" Height="600" Padding="10" MinHeight="300"
                                AutoScroll="true" Layout="AbsoluteLayout">
                                <Items>
                                    <ext:Button ID="Button1" runat="server" Text="Update Currency" X="140" Y="10" Width="180">
                                        <Listeners>
                                            <Click Fn="Addnew" />
                                        </Listeners>
                                    </ext:Button>
                                      <ext:Button ID="Button8" runat="server" Text="View All" Width="75" X="350" Y="10">
                                        <DirectEvents>
                                       ...
                                       Height="550" X="10" Y="40">
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column Header="Station" Width="80" DataIndex="Station" />
                                                <ext:Column Header="Userid" Width="80" DataIndex="Userid" />
                                                <ext:Column Header="User Name" Width="100" DataIndex="UserName" />
                                                <ext:Column Header="Currency" DataIndex="Currency" />
...
<ext:RecordField Name="UserID" />
                        ...
                        <DirectEvents>
                            <KeyUp OnEvent="GetUser">
                                      ...
                                      <ext:ComboBox StoreID="Store2" ID="DLCurrency" runat="server"  FieldLabel="Acccount Name" LabelWidth="65" Width="145" X="200" Y="10" SelectedIndex="1" DisplayField="CurrencyCode"  ValueField="CurrencyCode">
                                        <Items>
                                        </Items>

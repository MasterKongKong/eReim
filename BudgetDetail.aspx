<%@ Page Language="C#" AutoEventWireup="true" Inherits="eReimbursement.BudgetDetail"
    CodeBehind="BudgetDetail.aspx.cs" %>
            ...
            <ext:Panel ID="Panel1" runat="server" Height="680" Border="false">
                <Items>
                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                                    ...
                                    <ext:TreePanel ID="TreePanel1" runat="server" Header="false" Lines="false" UseArrows="true"
                                        ...
                                        <Root>
                                            <ext:TreeNode Text="申请单" Expanded="true">
                                                <Nodes>
                                                    <ext:TreeNode Text="预算录入" Expanded="true" Href="Budget.aspx" Icon="UserKey"
                                                        NodeID="a1">
                                                    </ext:TreeNode>
                                                    <ext:TreeNode Text="预算管理" Expanded="true" Href="BudgetReport.aspx" Icon="UserKey" NodeID="a2">
                                                    </ext:TreeNode>
                                                </Nodes>
                                            </ext:TreeNode>
                                        </Root>
                        ...
                        <Center>
                            <ext:Panel ID="Panel3" runat="server" Title="预算管理" Padding="10" AutoScroll="true"
                                ...
                                <Items>
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                        Title="预算管理." TrackMouseOver="false" Height="380" X="10" Y="100">
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:Column Header="Account code" Width="110" DataIndex="Accountcode">
                                                </ext:Column>
                                                <ext:Column Header="Description" Width="130" DataIndex="Description">
                                                </ext:Column>
                                                <ext:Column Header="Jan" Width="60" DataIndex="m1">
                                                </ext:Column>
                                                <ext:Column Header="Feb" Width="60" DataIndex="m2">
                                                </ext:Column>
                                                <ext:Column Header="Mar" Width="60" DataIndex="m3">
                                                </ext:Column>
                                                <ext:Column Header="Apr" Width="60" DataIndex="m4">
                                                </ext:Column>
                                                <ext:Column Header="May" Width="60" DataIndex="m5">
                                                </ext:Column>
                                                <ext:Column Header="Jun" Width="60" DataIndex="m6">
                                                </ext:Column>
                                                <ext:Column Header="Jul" Width="60" DataIndex="m7">
                                                </ext:Column>
                                                <ext:Column Header="Aug" Width="60" DataIndex="m8">
                                                </ext:Column>
                                                <ext:Column Header="Sep" Width="60" DataIndex="m9">
                                                </ext:Column>
                                                <ext:Column Header="Oct" Width="60" DataIndex="m10">
                                                </ext:Column>
                                                <ext:Column Header="Nov" Width="60" DataIndex="m11">
                                                </ext:Column>
                                                <ext:Column Header="Dec" Width="60" DataIndex="m12">
                                                </ext:Column>

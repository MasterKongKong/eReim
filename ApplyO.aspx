<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyO.aspx.cs" Inherits="eReimbursement.ApplyO" %>
...
<head>
    ...
    <script type="text/javascript">
        var LOADCOATip = function () {
            var record = cbxCOA.findRecord(cbxCOA.displayField, this.triggerElement.innerHTML.replace(/&amp;/, '&'));
        ...
        var PostData = function () {
            ...
            var temps = parentStore.query('Type', 'O').items;
            ...
            for (var i = 0; i < Store1.getAllRange().length; i++) {
                ...
                newrecord.data.SubType = record.COAName;
//                if (getCookie('lang') != undefined && getCookie('lang').toLowerCase() == 'zh-cn') {
//                    newrecord.data.SubType = '其他费用';
//                }
//                else {
//                    newrecord.data.SubType = 'Other Expense';
//                }
        ...
        <Items>
                            ...
                            <ext:LayoutColumn ColumnWidth="1">
                                <ext:Panel ID="Panel43" runat="server" Padding="10" Title="<%$ Resources:LocalText,ExpenseDetail%>"
                                    ...
                                    <Items>
                                        ...
                                        <ext:ComboBox ID="cbxCOA" runat="server" FieldLabel="<%$ Resources:LocalText,ExpenseItem%>"
                                            X="10" Y="10" Width="315" LabelWidth="85" EmptyText="COA Type" DisplayField="COAName"
                                            ValueField="COACode">
                                            <Store>
                                        ...
                                        <ext:NumberField ID="nfAmount1" runat="server" FieldLabel="<%$ Resources:LocalText,Amount%>"
                                            X="120" Y="40" Width="110" LabelWidth="50" />
                                        <ext:DateField ID="dfDate" runat="server" FieldLabel="<%$ Resources:LocalText,Date%>"
                                            Format="yyyy/MM/dd" X="235" Y="40" Width="160" LabelWidth="40" EmptyText="yyyy/MM/dd" />
                                        <ext:ComboBox ID="cbxTStation" runat="server" FieldLabel="<%$ Resources:LocalText,CostCenter%>"
                                            X="415" Y="40" Width="180" LabelWidth="70" EmptyText="Station Code" DisplayField="cityCode"
            ...
            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" Title="<%$ Resources:LocalText,ExpenseList%>"
                ...
                <Listeners>
                    ...
                    <Render Handler="if(parent.AddSubStore('O')){EditBudgetCurrentStatus();}" />
                </Listeners>
            </ext:GridPanel>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyTransportation.aspx.cs"
    Inherits="eReimbursement.ApplyTransportation" %>
...
<head>
    ...
    <title>Transportation Claim Form</title>
            ...
            <ext:Panel ID="Panel1" runat="server" Height="680" Border="false">
                <Items>
                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                        ...
                        <Center>
                            <ext:Panel ID="Panel3" runat="server" Title="交通费申请单 - 表单:ZJDBJS2013010001" Height="600"
                                ...
                                <Items>
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                        ...
                                        AutoExpandColumn="Purpose" X="10" Y="130">
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" X="10" Y="330" Height="160" Layout="AbsoluteLayout"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField ID="txtFrom" runat="server" FieldLabel="起始地" X="10" Y="40" Width="750"
                                                LabelWidth="70" Anchor="100%">
                                            </ext:TextField>
                                            <ext:TextField ID="txtTo1" runat="server" FieldLabel="目的地" X="10" Y="70" Width="750"
                                                LabelWidth="70" Anchor="100%">
                                            </ext:TextField>
                                            <ext:TextField ID="txtPurpose1" runat="server" FieldLabel="费用描述" X="10" Y="100" Width="750"
                                                LabelWidth="70" Anchor="100%">
                                            </ext:TextField>

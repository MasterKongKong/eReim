<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyCommu.aspx.cs" Inherits="eReimbursement.ApplyCommu" %>
...
<head>
    ...
    <title>Communication Expenses</title>
            ...
            <ext:Panel ID="Panel1" runat="server" Height="680" Border="false">
                <Items>
                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                        ...
                        <Center>
                            <ext:Panel ID="Panel3" runat="server" Title="通讯费申请单 - 表单:ZJDBJS2013010001" Height="600"
                                ...
                                <Items>
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column Header="作用区间" Width="100" DataIndex="Qujian" />
                                                <ext:Column Header="类型" Width="120" DataIndex="Type" />
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" X="10" Y="330" Height="160" Layout="AbsoluteLayout"
                                        ...
                                        <Items>
                                            <ext:TextField ID="TextField1" runat="server" FieldLabel="作用区间" X="10" Y="10" Width="205"
                                                LabelWidth="70" />
                                            ...
                                            <ext:ComboBox ID="ComboBox3" runat="server" FieldLabel="类型" LabelWidth="70" X="10"
                                                Y="40" SelectedIndex="0" Width="205">
                                                <Items>
                                                    <ext:ListItem Text="IP电话费" />
                                                    <ext:ListItem Text="国际长途电话费" />
                                                </Items>
                                            </ext:ComboBox>
